...
namespace serval::variant {
    ...
    using Container = std::variant<std::uint8_t, bool, std::int32_t, std::int64_t, Scalar, entt::entity, serval::Id, glm::vec2, glm::vec3, glm::vec4, glm::quat, serval::ContainerHandle, serval::Handle, Invalid>;
    ...
    struct detail {
        ...
        template <> struct TypeOf<Type::Scalar> { using Type = Scalar; };
